...
usage:
python generateUserStudyData.py

writes data to  user_study_files/ directory
each file in this directory is a list of yaml files found in the subfolder yaml_files
...
relationship_list = ["right", "left", "up", "down", "on"]
